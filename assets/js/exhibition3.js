...
//     getProcessId.appendChild(newSection).appendChild(p);
//     newSection.setAttribute("id",  i);
...
/** CREATE ALL SECTION WITH A CLASS FROM ARRAY */

objContent.className = contentKeys.join(' ')

objContent.forEach(cls => { // cls representing each value of myArray.
    let section = document.createElement('section');
    // let classId = 
     section.classList.add(cls);
    // div.setAttribute('id', idDiv[0] )
    getProcessId.appendChild(section)
});
